...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2 bg-background">
      {/* Panel izquierdo navy con cita ACL */}
      <aside className="hidden lg:flex flex-col justify-between bg-sidebar text-sidebar-foreground p-12 relative overflow-hidden">
        ...
        <div className="relative flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[11px] uppercase tracking-[0.18em] text-sidebar-foreground/60">FacturaFlow</p>
          </div>
        </div>

        <div className="relative max-w-md">
          <p className="font-heading text-3xl xl:text-4xl leading-snug text-sidebar-foreground">
            “Sus facturas, del correo a QuickBooks
            <span className="text-sidebar-foreground/70"> — validadas y sin digitar una sola línea.”</span>
          </p>
          <div className="mt-10 grid grid-cols-3 gap-6 border-t border-sidebar-foreground/15 pt-6">
            <div>
              <p className="text-2xl font-heading font-semibold">XML v4.x</p>
              <p className="text-[11px] uppercase tracking-wider text-sidebar-foreground/60 mt-1">Estándar CR</p>
            </div>
            <div>
              <p className="text-2xl font-heading font-semibold">IVA</p>
              <p className="text-[11px] uppercase tracking-wider text-sidebar-foreground/60 mt-1">Validado</p>
            </div>
            <div>
              <p className="text-2xl font-heading font-semibold">QBO</p>
              <p className="text-[11px] uppercase tracking-wider text-sidebar-foreground/60 mt-1">Sincronizado</p>
            </div>
          </div>
        </div>

        <div className="relative flex items-center gap-2 text-xs text-sidebar-foreground/70">
          <span className="h-1.5 w-1.5 rounded-full bg-[hsl(var(--success))]" />
          Conectado con QuickBooks Online
        </div>
      </aside>
      ...
      <section className="flex items-center justify-center p-6 sm:p-10">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8 hidden lg:block">
            <h2 className="text-3xl font-heading font-semibold text-foreground">Bienvenido</h2>
            <p className="text-sm text-muted-foreground mt-1">
              Ingresa para gestionar la facturación electrónica de tu empresa.
            </p>
          </div>
