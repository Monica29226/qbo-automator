...
interface OutlookFetchDialogProps {
  onSuccess?: () => void;
}

export const OutlookFetchDialog = ({ onSuccess }: OutlookFetchDialogProps) => {
  ...
  const handleFetch = async () => {
    ...
    toast.info("Obteniendo facturas de Outlook...");
    ...
    try {
      ...
      const { data, error } = await supabase.functions.invoke("outlook-fetch-invoices", {
        body,
      });
      ...
      console.error("Error fetching Outlook invoices:", error);
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle>Obtener Facturas de Outlook</DialogTitle>
          <DialogDescription>
