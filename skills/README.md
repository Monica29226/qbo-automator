# Skills de FacturaFlow

Instrucciones cargables "on demand" para el agente de Lovable. A diferencia del **Knowledge** (que siempre está en contexto), un **Skill** se usa cuando la tarea coincide con su tema. Pegá el contenido de cada archivo en la UI de Skills de Lovable (o referencialos desde aquí).
...
Mantener actualizados cuando cambie una regla de negocio.
